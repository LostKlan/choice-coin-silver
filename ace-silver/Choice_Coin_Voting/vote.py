...
matplotlib.use('agg')
algod_address = "https://testnet-algorand.api.purestake.io/ps2"  # Put Algod Token here
...
decision_one = "3JTSHP4IT2JAHDN3PXY64E2DU6GCVPTLPXHLOK5JDSFGKH3WIV2GCFU6QY"
decision_two = "3JTSHP4IT2JAHDN3PXY64E2DU6GCVPTLPXHLOK5JDSFGKH3WIV2GCFU6QY"
...
def choice_vote(sender, key, receiver, amount, comment):
    ...
    transaction = AssetTransferTxn(
        sender, parameters, receiver, 0, choice_id, note=comment)
...
def show_results(yes_count, no_count):
    ...
    plt.savefig('./static/img/plot.png', dpi=400,
